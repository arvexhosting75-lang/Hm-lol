...
BOT_NAME = os.getenv('BOT_NAME', 'Auralixs')
...
def create_embed(title, description="", color=EmbedColors.PRIMARY, show_branding=True):
    ...
    if show_branding:
        embed.set_footer(
            ...
            icon_url="https://www.image2url.com/r2/default/images/1781239797542-6a431a57-b8eb-4bdb-ae36-80220f6a6d6e.png"
        )
...
async def uptime(ctx):
    ...
    embed.set_thumbnail(url="https://www.image2url.com/r2/default/images/1781239797542-6a431a57-b8eb-4bdb-ae36-80220f6a6d6e.png")
...
async def delete_vps(ctx, user: discord.Member, vps_number: int, *, reason: str = "No reason"):
    ...
    # 4️⃣ Success embed
    embed = create_success_embed("🌟 Auralixs - VPS Deleted Successfully")
...
async def user_info(ctx, user: discord.Member):
    ...
    embed.set_footer(text="Auralixs • User Resource Dashboard")
    embed.timestamp = ctx.message.created_at
...
async def server_stats(ctx):
    ...
    embed.set_footer(text="Auralixs • Real-Time Monitoring")
    embed.timestamp = ctx.message.created_at
